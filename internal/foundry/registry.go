...
func (registry *Registry) Casting(deployment v1alpha1.TypeDeployment) (casting.Casting, error) {
	...
	if !ok {
		return nil, fmt.Errorf("deployment '%+v' is not supported, raise an issue at https://github.com/hanzoai/o11y-foundry/issues to request support for this deployment", deployment)
	}
